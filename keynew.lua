...
local Config = {
    ...
    ServiceId       = 23405, -- Your PlatoBoost Service ID
    PlatoSecret     = "5fec9b37-2d9f-46ce-a327-439083cf7d93", -- Your PlatoBoost Secret Key

    -- [2] Anti-Bypass / Global Secret Variable
    Secret          = "123123123@WIN", -- This makes the script ONLY run from the key script. Even if they copy the original obfuscated script to bypass the key, they won't be able to!
    
    -- [3] Scripts & Links
    MainScriptURL   = "https://raw.githubusercontent.com/Ttttttt55/my-script/refs/heads/main/sa", -- The raw URL of your main script
    ...
    -- [6] GUI Management
    OldGuiName      = "TODHOMMAK", -- Name of the old GUI to destroy if it's already open
    MainGuiName     = "TODHOMMAK", -- Name of the main script's GUI to check if it's already executing

    -- [7] Hub Information & UI Text
    HubName         = "TODHOMHUB", -- The main title shown at the top of the GUI
    HubDescription  = "THX for play" -- The text shown below the title
}
